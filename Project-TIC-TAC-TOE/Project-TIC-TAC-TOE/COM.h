...
namespace ProjectTICTACTOE {
	...
	/// </summary>
	public ref class COM : public System::Windows::Forms::Form
	{
		static int Second = 0;
		static int Minute = 0;
		String^ Sec;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(COM::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &COM::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &COM::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &COM::button3_Click);
			// 
			// button4
			// 
			...
			this->button4->Click += gcnew System::EventHandler(this, &COM::button4_Click);
			// 
			// button5
			// 
			...
			this->button5->Click += gcnew System::EventHandler(this, &COM::button5_Click);
			// 
			// button6
			// 
			...
			this->button6->Click += gcnew System::EventHandler(this, &COM::button6_Click);
			// 
			// button7
			// 
			...
			this->button7->Click += gcnew System::EventHandler(this, &COM::button7_Click);
			// 
			// button8
			// 
			...
			this->button8->Click += gcnew System::EventHandler(this, &COM::button8_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &COM::button9_Click);
			// 
			// button10
			// 
			...
			this->button10->Click += gcnew System::EventHandler(this, &COM::button10_Click_1);
			// 
			// textBox1
			// 
			...
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &COM::textBox1_TextChanged_1);
			// 
			// button12
			// 
			...
			this->button12->Click += gcnew System::EventHandler(this, &COM::button12_Click);
			// 
			// textBox2
			// 
			...
			this->textBox2->TextChanged += gcnew System::EventHandler(this, &COM::textBox2_TextChanged);
			// 
			// textBox3
			// 
			...
			this->textBox3->TextChanged += gcnew System::EventHandler(this, &COM::textBox3_TextChanged);
			// 
			// textBox4
			// 
			...
			this->textBox4->TextChanged += gcnew System::EventHandler(this, &COM::textBox4_TextChanged);
			// 
			// textBox5
			// 
			...
			this->textBox6->TextChanged += gcnew System::EventHandler(this, &COM::textBox6_TextChanged);
			// 
			// textBox7
			// 
			...
			this->textBox7->TextChanged += gcnew System::EventHandler(this, &COM::textBox7_TextChanged);
			// 
			// textBox8
			// 
			...
			this->label1->Click += gcnew System::EventHandler(this, &COM::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &COM::label2_Click);
			// 
			// label3
			// 
			...
			this->label3->Click += gcnew System::EventHandler(this, &COM::label3_Click);
			// 
			// label4
			// 
			...
			this->label4->Click += gcnew System::EventHandler(this, &COM::label4_Click);
			// 
			// pictureBox3
			// 
			...
			this->textBox11->TextChanged += gcnew System::EventHandler(this, &COM::textBox11_TextChanged);
			// 
			// label5
			// 
			...
			this->label5->Click += gcnew System::EventHandler(this, &COM::label5_Click);
			// 
			// textBox12
			// 
			...
			this->label6->Click += gcnew System::EventHandler(this, &COM::label6_Click);
			// 
			// label7
			// 
			...
			this->label7->Click += gcnew System::EventHandler(this, &COM::label7_Click);
			// 
			// button13
			// 
			...
			this->button13->Click += gcnew System::EventHandler(this, &COM::button13_Click);
			// 
			// textBox13
			// 
			...
			this->textBox13->TextChanged += gcnew System::EventHandler(this, &COM::textBox13_TextChanged);
			// 
			// button14
			// 
			...
			this->button14->Click += gcnew System::EventHandler(this, &COM::button14_Click);
			// 
			// textBox14
			// 
			...
			this->textBox14->TextChanged += gcnew System::EventHandler(this, &COM::textBox14_TextChanged);
			// 
			// textBox15
			// 
			...
			this->textBox15->TextChanged += gcnew System::EventHandler(this, &COM::textBox15_TextChanged);
			// 
			// textBox25
			// 
			...
			this->textBox25->Location = System::Drawing::Point(21, 27);
			...
			this->textBox25->TextChanged += gcnew System::EventHandler(this, &COM::textBox25_TextChanged);
			// 
			// textBox26
			// 
			...
			this->textBox26->Location = System::Drawing::Point(235, 30);
			this->textBox26->Margin = System::Windows::Forms::Padding(2);
			this->textBox26->Name = L"textBox26";
			this->textBox26->ReadOnly = true;
			this->textBox26->Size = System::Drawing::Size(73, 31);
			this->textBox26->TabIndex = 0;
			this->textBox26->TabStop = false;
			this->textBox26->Text = L"COM";
			this->textBox26->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			this->textBox26->TextChanged += gcnew System::EventHandler(this, &COM::textBox26_TextChanged);
			// 
			// button11
			// 
			...
			this->button11->Click += gcnew System::EventHandler(this, &COM::button11_Click);
			// 
			// button15
			// 
			...
			this->button15->Location = System::Drawing::Point(65, 270);
			this->button15->Name = L"button15";
			this->button15->Size = System::Drawing::Size(182, 52);
			this->button15->TabIndex = 36;
			this->button15->Text = L"CLICK TO RANDOMLY ASSIGN -> O";
			this->button15->UseVisualStyleBackColor = false;
			this->button15->Click += gcnew System::EventHandler(this, &COM::button15_Click);
			// 
			// pictureBox1
			// 
			...
			this->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(67)), static_cast<System::Int32>(static_cast<System::Byte>(67)),
				static_cast<System::Int32>(static_cast<System::Byte>(67)));
			this->ClientSize = System::Drawing::Size(317, 499);
			...
			this->Text = L"COM";
			this->Load += gcnew System::EventHandler(this, &COM::GameMenu_Load);
...
#pragma endregion
	...
	private: System::Void button15_Click(System::Object^ sender, System::EventArgs^ e) {
		if ((B2 == false || B3 == false || B4 == false || B5 == false || B6 == false || B7 == false || B8 == false || B9 == false || B10 == false) && p1win == false && comwin == false)
		{
			if (checker == true)
				com();
		}
